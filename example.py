...
num_training_imgs = 19
train_img_path = path + r'data/train/19 images/*.png'
...
def run():
    ...
    fs1 = SelectPercentile(score_func=f_classif, percentile=75)
    fs1.fit(feature_list_unit1, gt_list)
    new_features1 = fs1.transform(feature_list_unit1)
    print(new_features1.shape)
    print(fs1.scores_)
    
    fs2 = SelectPercentile(score_func=f_classif, percentile=75)
        ...
        if 'raw' in test_img_addr: # only want to load testing images that are raw
            ...
            for i in range(0, img_size, delta_x):
                for j in range(0, img_size, delta_x):
                    ...
                    del test_feature_red1, test_feature_red2, feature_list_unit1, feature_list_unit2
            ...
            print(path +'results/'+os.path.basename(test_img_addr))
